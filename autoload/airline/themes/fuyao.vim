...
let g:airline#themes#fuyao#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#fuyao#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
...
let g:airline#themes#fuyao#palette.inactive_modified = {
      \ 'airline_c': [ '#e25000' , '' , 166 , 235, '' ] ,
       \ }

let g:airline#themes#fuyao#palette.tabline = {
      \ 'airline_tab':      ['#c8c8c8' , '#2e2e2e' , 240 , 235 , '' ],
      \ 'airline_tabsel':   ['#2e2e2e' , '#a4c639' , 7 , 240 , '' ],
      \ 'airline_tabfill':  ['#c8c8c8' , '#2e2e2e' , 240 , 235 , '' ],
      \ 'airline_tabtype':  ['#c8c8c8' , '#2e2e2e' , 240 , 10 , '' ],
      \ 'airline_tabmod':   ['#2e2e2e' , '#a4c639' , 232 , 40 , '' ],
      \ }
